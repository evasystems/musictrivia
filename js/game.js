...
new Question('Whose signature guitar technique is called the \'windmill\'?', 'Pete Townshend', [ 'Pete Townshend', 'Eddie Van Halen', 'Jimi Hendrix', 'Jimmy Page'], 1);
new Question('Who is the primary lyricist for Canadian progressive rock band Rush?', 'Neil Peart', [ 'Neil Peart', 'Geddy Lee', 'Alex Lifeson', 'John Rutsey'], 2);
...
new Question('Who is the lead singer of the British pop rock band Coldplay?', 'Chris Martin', [ 'Chris Martin', 'Will Champion', 'Guy Berryman', 'Jonny Buckland'], 1);
...
new Question('What is the real name of Canadian electronic music producer deadmau5?', 'Joel Zimmerman', [ 'Joel Zimmerman', 'Adam Richard Wiles', 'Thomas Wesley Pentz', 'Sonny Moore'], 2);
new Question('What is the name of the main character from the music video of \'Shelter\' by Porter Robinson and A-1 Studios?', 'Rin', [ 'Rin', 'Ram', 'Rem', 'Ren'], 2);
new Question('Which song in Drake\'s \'Views\' features Future?', 'Grammys', [ 'Grammys', 'Too Good', 'Pop Style', 'Faithful'], 2);
new Question('\'Lift Your Spirit\' is an album by which artist?', 'Aloe Blacc', [ 'Aloe Blacc', 'Taylor Swift', 'Lena Meyer-Landrut', 'Stevie Wonder'], 2);
...
new Question('What was David Bowie\'s real surname?', 'Jones', [ 'Jones', 'Carter', 'Edwards', 'Johnson'], 2);
...
new Question('What was the title of ABBA`s first UK hit single?', 'Waterloo', [ 'Waterloo', 'Mamma Mia', 'Fernando', 'Dancing Queen'], 2);
...
new Question('What is the British term for a 64th note?', 'Hemidemisemiquaver', [ 'Hemidemisemiquaver', 'Demisemiquaver', 'Semiquaver', 'Semihemidemisemiquaver'], 3);
...
new Question('What is the real name of Canadian electronic music producer deadmau5?', 'Joel Zimmerman', [ 'Joel Zimmerman', 'Sonny Moore', 'Adam Richard Wiles', 'Thomas Wesley Pentz'], 2);
...
new Question('Which of these is NOT a song by Pegboard Nerds?', 'WiFi Tears', [ 'WiFi Tears', 'Swamp Thing', 'BAMF', 'Emoji'], 2);
...
new Question('Who was the lead singer and frontman of rock band R.E.M?', 'Michael Stipe', [ 'Michael Stipe', 'Chris Martin', 'Thom Yorke', 'George Michael'], 2);
new Question('What is rapper Drake\'s real name?', 'Aubrey Graham', [ 'Aubrey Graham', 'Shaun Carter', 'Dwayne Carter', 'Andre Young'], 2);
new Question('Pete Townshend collaborated with which famous guitarist for an event at Brixton Academy in 1985?', 'David Gilmour', [ 'David Gilmour', 'Eric Clapton', 'Jimmy Page', 'Mark Knopfler'], 3);
new Question('Electronic artists Boys Noize and Skrillex have collaborated and released tracks under what name?', 'Dog Blood', [ 'Dog Blood', 'Noisia', 'Jack Ü', 'What So Not'], 3);
...
new Question('Who is the lead singer of the band Coldplay?', 'Chris Martin', [ 'Chris Martin', 'Chris Connelly', 'Chris Isaak', 'Chris Wallace'], 1);
new Question('Who had a 1981 hit with the song \'Japanese Boy\'?', 'Aneka', [ 'Aneka', 'Toyah', 'Madonna', 'Sandra'], 3);
new Question('Which country is singer Kyary Pamyu Pamyu from?', 'Japan', [ 'Japan', 'South Korea', 'Vietnam', 'China'], 2);
new Question('Which song is not by TheFatRat?', 'Ascent', [ 'Ascent', 'Monody', 'Windfall', 'Infinite Power!'], 2);
...
new Question('Which brass instrument has the lowest pitch in an orchestra?', 'Tuba', [ 'Tuba', 'Trumpet', 'Trombone', 'Saxophone'], 1);
new Question('Which of these songs is not by Tatsuro Yamashita?', 'Lucky Lady Feel So Good ', [ 'Lucky Lady Feel So Good ', 'Love Talkin', 'Let\'s Dance Baby', 'Merry-Go Round'], 3);
...
new Question('In what film was the Michael Jackson song \'Will You Be There\' featured?', 'Free Willy', [ 'Free Willy', 'Sleepless in Seattle', 'Bad Boys', 'Men in Black'], 2);
new Question('Who is the lead singer of Bastille?', 'Dan Smith', [ 'Dan Smith', 'Kyle Simmons', 'Chris Wood', 'Will Farquarson'], 2);
new Question('Who performed \'I Took A Pill In Ibiza\'?', 'Mike Posner', [ 'Mike Posner', 'Avicii', 'Robbie Williams', 'Harry Styles'], 1);
new Question('Which of these is NOT a song by Pegboard Nerds?', 'WiFi Tears', [ 'WiFi Tears', 'Emoji', 'BAMF', 'Swamp Thing'], 2);
new Question('When was Gangnam Style uploaded to YouTube?', '2012', [ '2012', '2013', '2014', '2011'], 1);
...
new Question('Who had a 1973 hit with the song \'Hocus Pocus\'?', 'Focus', [ 'Focus', 'Rush', 'AC/DC', 'Pilot'], 2);
...
new Question('Who is the lead singer of the band Coldplay?', 'Chris Martin', [ 'Chris Martin', 'Chris Isaak', 'Chris Connelly', 'Chris Wallace'], 1);
...
new Question('What was Rage Against the Machine\'s debut album?', 'Rage Against the Machine', [ 'Rage Against the Machine', 'Evil Empire', 'The Battle Of Los Angeles', 'Bombtrack'], 1);
new Question('Which country does the power metal band \'Sabaton\' originate from?', 'Sweden', [ 'Sweden', 'United States', 'Germany', 'Finland'], 2);
new Question('Which of these is the name of a song by Tears for Fears?', 'Shout', [ 'Shout', 'Shriek', 'Yell', 'Scream'], 1);
...
new Question('What album did The Lumineers release in 2016?', 'Cleopatra', [ 'Cleopatra', 'Winter', 'The Lumineers', 'Tracks From The Attic'], 1);
...
new Question('Which American family band had a 1986 top 10 hit with the song \'Crush On You\'?', 'The Jets', [ 'The Jets', 'The Jacksons', 'The Cover Girls', 'DeBarge'], 2);
...
new Question('Which of these artists do NOT originate from France?', 'The Chemical Brothers', [ 'The Chemical Brothers', 'Daft Punk', 'Air', 'Justice'], 2);
new Question('In which city did American rap producer DJ Khaled originate from?', 'Miami', [ 'Miami', 'Atlanta', 'Detroit', 'New York'], 2);
...
new Question('Which one of these Pink Floyd albums were also a movie?', 'The Wall', [ 'The Wall', 'Wish You Were Here', 'Animals', 'The Dark Side of the Moon'], 2);
new Question('Which of these is the name of a song by Tears for Fears?', 'Shout', [ 'Shout', 'Yell', 'Scream', 'Shriek'], 1);
new Question('What is the name of French electronic music producer Madeon\'s 2015 debut studio album?', 'Adventure', [ 'Adventure', 'Pop Culture', 'Icarus', 'The City'], 2);
...
new Question('The key of sharps does the key of G# minor contain?', '5', [ '5', '7', '3', '0'], 3);
...
new Question('When was Gangnam Style uploaded to YouTube?', '2012', [ '2012', '2011', '2014', '2013'], 1);
new Question('Which classical composer wrote the \'Moonlight Sonata\'?', 'Ludvig Van Beethoven', [ 'Ludvig Van Beethoven', 'Johannes Brahms', 'Chief Keef', 'Wolfgang Amadeus Mozart'], 1);
...
new Question('What year was Min Yoongi from South Korea boy band \'BTS\' born in?', '1993', [ '1993', '1995', '1992', '1994'], 3);
...
new Question('Where did the British Boy Band \'Bros\' come from?', 'Camberley', [ 'Camberley', 'Bagshot', 'Guildford', 'Aldershot'], 2);
